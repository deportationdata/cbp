...
contained_pairs_path <- file.path(
  validation_dir,
  "inadmissibles-contained-pairs.parquet"
)

daily_comparison_path <- file.path(
  validation_dir,
  "inadmissibles-overlap-daily-comparison.parquet"
)

pair_summary_path <- file.path(
  validation_dir,
  "inadmissibles-overlap-pair-summary.parquet"
)
...
parse_inadmissible_date <- function(x) {
