...
parts_metadata <- read_parquet(
  "data/encounters/metadata/parts_metadata.parquet"
)
...
encounters_timeline <- ggplot(
  ...
  labs(
    title = "Date Coverage of Encounter Parts",
    x = "Date Coverage",
    y = NULL,
...
# save plot
ggsave(
  "data/encounters/metadata/encounters_parts_timeline.pdf",
  plot = encounters_timeline,
  width = 24,
  height = 14,
  units = "in",
  limitsize = FALSE
