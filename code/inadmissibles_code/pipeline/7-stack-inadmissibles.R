...
inadmissibles_stacked_path <- file.path(
  processed_dir,
...
inadmissibles_audit_path <- file.path(
  processed_dir,
  "inadmissibles_audit.parquet"
)

# to delete from parts_to_stack
parts_to_delete <- c(
  "0029_ofo_inadmissible_case_by_case_feb_2025_0_report_1.parquet"
)
...
# reduce memory use for large parquet 
dbExecute(
  con,
